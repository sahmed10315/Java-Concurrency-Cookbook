...
class FactorialCallable implements Callable<Long> {
	long n;

	public FactorialCallable(long n) {
		this.n = n;
	}
...
public class Factorial {
	...
	public static void main(String[] args) throws Exception {
		...
		Callable<Long> task = new FactorialCallable(N);
		...
		// wait for the get() method that blocks till the computation is
		// complete.
